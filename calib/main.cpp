...
// epipolar geometry constraint: m2^t*F*m1=0
    ...
    FileStorage fs("./images/intrinsics.yml", FileStorage::WRITE);
    if( fs.isOpened() )
    {
...
int main(int argc, char** argv)
{
    ...
    cv::CommandLineParser parser(argc, argv, "{sc|false|}{w|8|}{h|6|}{nr||}{help||}{@input|./images/stereo_calib.xml|}");
    if (parser.has("help"))
        return print_help();
